...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO product VALUES('$product_id','$description','$price','$unit')");
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content">
        ...
        <div class="page-title-box d-flex justify-content-between align-items-center">
            <h3><span class="icon-wrapper"><i class="fa-solid fa-plus"></i></span> Tambah Produk</h3>
        </div>
        ...
        <div class="form-card">
            <form action="" method="post">
                <div class="modern-input-group">
                    ...
                    <input type="text" name="product_id" class="form-control" placeholder="Contoh: P001" required>
                </div>
                
                <div class="modern-input-group">
                    <label>Description</label>            
                    <input type="text" name="description" class="form-control" placeholder="Nama / Deskripsi Produk" required>
                </div>
                ...
                <div class="modern-input-group">
                    <label>Unit</label>
                    <input type="text" name="unit" class="form-control" placeholder="Contoh: galon, liter, pcs" required>
                </div>
