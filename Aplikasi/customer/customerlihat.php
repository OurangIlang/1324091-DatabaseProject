...
<head>
  ...
  <style>
    ...
    .page-title-box h3 {
        margin: 0; font-size: 1.1rem; color: #333; font-weight: 700;
    ...
    .dataTables_wrapper .form-control-sm {
        border-radius: 15px; padding: 4px 10px; font-size: 11px; border: 1px solid #e9ecef;
    }
    .dataTables_wrapper .dataTables_info,
    .dataTables_wrapper .dataTables_paginate { font-size: 11px; margin-top: 10px; }
    .dataTables_wrapper .pagination .page-item.active .page-link {
        background-color: var(--accent-color); border-color: var(--accent-color);
    }
    .dataTables_wrapper .page-link {
        color: #6c757d; border-radius: 15px; margin: 0 2px; padding: 4px 10px;
    }
  </style>
</head>
  ...
  <div class="wrapper d-flex align-items-stretch">
    <nav id="sidebar">
      <div class="p-4 pt-5">
        ...
        <ul class="list-unstyled components mb-5">
          ...
          <li class="active"><a href="../customer/customerlihat.php" aria-expanded="false"><i class="fa-solid fa-users mr-2"></i> customer</a></li>
    ...
    <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="nav navbar-nav ml-auto">
              ...
              <li class="nav-item active"><a class="nav-link" href="../customer/customerlihat.php">customer</a></li>
      ...
      <div class="page-title-box d-flex justify-content-between align-items-center">
          <h3><span class="icon-wrapper"><i class="fa-solid fa-users"></i></span> Data Customer</h3>
          <a href="customertambah.php" class="btn btn-accent btn-sm-modern rounded-pill" style="font-size: 11px; padding: 6px 14px;">
        ...
        <table id="example" class="table table-hover table-sm table-kecil" style="width:100%; text-align: center;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="text-align: start;"><?php echo $data['customer_name']; ?></td>
              <td><?php echo $data['address']; ?></td>
              <td><?php echo $data['city']; ?></td>
              <td><?php echo $data['phone']; ?></td>
              <td>
                <a class="btn btn-warning-modern btn-sm-modern" href="customerubah.php?customer_id=<?php echo $data['customer_id']; ?>">
                    <i class="fa-solid fa-pen"></i> Ubah
                </a> 
                &nbsp;
                <a class="btn btn-danger btn-sm-modern" href="customerhapus.php?customer_id=<?php echo $data['customer_id']; ?>" onclick="return confirm('yakin hapus?')">
