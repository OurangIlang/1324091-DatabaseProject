...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "INSERT INTO customer VALUES('$customer_id','$customer_name','$address', '$city', '$phone')");
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content">
        ...
        <div class="page-title-box d-flex justify-content-between align-items-center">
            <h3><span class="icon-wrapper"><i class="fa-solid fa-user-plus"></i></span> Tambah Customer</h3>
        </div>
        ...
        <div class="form-card">
            <form action="" method="post">
                <div class="modern-input-group">
                    ...
                    <input type="text" name="customer_id" class="form-control" placeholder="Kode / ID Customer" required>
                </div>
                ...
                <div class="modern-input-group">
                    <label>Phone</label>
                    <input type="text" name="phone" class="form-control" placeholder="Nomor Telepon / HP" required>
                </div>
                
                <hr class="mt-4 mb-4">
                <div class="mt-4" style="text-align: right;">
                    <button type="submit" name="proses" class="btn btn-accent rounded-pill px-4 mr-2"><i class="fa-solid fa-check mr-1"></i> Simpan Data</button>
