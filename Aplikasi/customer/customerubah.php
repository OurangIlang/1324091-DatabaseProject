<?php
    include '../koneksi.php';
    $query = mysqli_query($conn, "SELECT * FROM customer WHERE customer_id = '$_GET[customer_id]'");
...
if (isset($_POST['proses'])){
    ...
    mysqli_query($conn, "UPDATE customer SET customer_name='$customer_name',address='$address',city='$city',phone='$phone' WHERE customer_id='$customer_id'");
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content">
        ...
        <div class="page-title-box d-flex justify-content-between align-items-center">
            <h3><span class="icon-wrapper"><i class="fa-solid fa-user-pen"></i></span> Ubah Customer</h3>
        </div>
        ...
        <div class="form-card">
            <form action="" method="post">
                ...
                <div class="modern-input-group">
                    <label>Nama</label>            
                    <input type="text" name="customer_name" value="<?php echo $data['customer_name'] ?>" class="form-control" required>
                </div>
                ...
                <div class="modern-input-group">
                    <label>City</label>
                    <input type="text" name="city" value="<?php echo $data['city'] ?>" class="form-control" required>
                </div>
                ...
                <div class="mt-4" style="text-align: right;">
                    ...
                    <a href="customerlihat.php" class="btn btn-danger rounded-pill px-4"><i class="fa-solid fa-times mr-1"></i> Batal</a>
                </div>
            </form>
        </div>
