<?php
include '../koneksi.php';
$query = mysqli_query($conn, "SELECT * FROM invoice WHERE invoice_id = '$_GET[invoice_id]'");
...
if (isset($_POST['proses'])) {
  ...
  mysqli_query($conn, "UPDATE invoice SET invoice_date='$invoice_date', no_pr='$no_pr', no_po='$no_po', payment='$payment' WHERE invoice_id='$invoice_id'");
  ...
  <head>
    ...
    <style>
        ...
        .modern-input-group .form-control { 
            ...
            height: auto; /* Mencegah teks terpotong */
        }
    ...
    <div class="wrapper d-flex align-items-stretch">
      ...
      <div id="content">
        ...
        <div class="page-title-box d-flex justify-content-between align-items-center">
            <h3><span class="icon-wrapper"><i class="fa-solid fa-pen"></i></span> Ubah Invoice</h3>
        </div>
        ...
        <div class="form-card">
            <form action="" method="post">
                <div class="modern-input-group">
                    ...
                    <input type="text" class="form-control" name="customer_id" value="<?php echo $data['customer_id']; ?>" readonly>
                </div>
                
                <div class="modern-input-group">
                    <label>Invoice ID</label>            
                    <input type="text" class="form-control" name="invoice_id" value="<?php echo $data['invoice_id']; ?>" readonly>
                </div>

                <div class="modern-input-group">
                    <label>Tanggal</label>
                    <input type="date" name="invoice_date" class="form-control" value="<?php echo $data['invoice_date'] ?>" required>
                </div>

                <div class="modern-input-group">
                    <label>No. PR</label>
                    <input type="text" name="no_pr" class="form-control" value="<?php echo $data['no_pr'] ?>">
                </div>

                <div class="modern-input-group">
                    <label>No. PO</label>
                    <input type="text" name="no_po" class="form-control" value="<?php echo $data['no_po'] ?>">
                </div>

                <div class="modern-input-group">
                    <label>Payment</label>
                    <input type="number" name="payment" class="form-control" value="<?php echo $data['payment'] ?>" readonly>
                </div>
